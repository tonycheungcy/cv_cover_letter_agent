...
Name: Tony Cheung
Phone: +852 9123 4567
Email: tony.cheung@connect.ust.hk
LinkedIn: linkedin.com/in/tonycheung
GitHub: github.com/tonycheung
...
- Built automated dashboards in Python (Plotly/Dash) for supply chain KPIs, reducing reporting time from 8 hours to 30 minutes weekly
- Analyzed customer churn patterns across 5,000+ users and identified retention factors that saved $120K annually
- Collaborated with 3 product teams to integrate ML recommendations into dashboard workflows

Operations Analytics Intern, Global Logistics Corp (Jan 2023 - Apr 2023)
- Optimized route planning for 80+ delivery routes using Python optimization algorithms, reducing fuel costs by 18%
- Designed A/B testing framework for warehouse slotting, increasing picking efficiency by 22%
- Presented findings to Director level, leading to $250K process improvement initiative
...
Data Science: Machine Learning, Time Series Forecasting, A/B Testing, Optimization
